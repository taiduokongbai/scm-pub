...
useStrict(true);
class CompanynatureStore  extends BaseDataStore{
    constructor(props, context) {
        super(props, context)
    }
    params={catCode:'',catName:'',status:null,subCode: "C017"}
...
let companynatureStore = new CompanynatureStore();
export  {companynatureStore}