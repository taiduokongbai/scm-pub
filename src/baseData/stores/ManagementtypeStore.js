...
useStrict(true);
class ManagementtypeStore  extends BaseDataStore{
    constructor(props, context) {
        super(props, context)
    }
    params={catCode:'',catName:'',status:null,subCode: "C019"}
...
let managementtypeStore = new ManagementtypeStore();
export  {managementtypeStore}