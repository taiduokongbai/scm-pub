...
useStrict(true);
class CompanysizeStore  extends BaseDataStore{
    constructor(props, context) {
        super(props, context)
    }
    params={catCode:'',catName:'',status:null,subCode: "C016"}
...
let companysizeStore = new CompanysizeStore();
export  {companysizeStore}