...
@observer
class AddAccountMethodComp extends Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                accountmethodStore.saveModalData(pm)
            }
        });
    }
    render() {
        ...
        return (
            <div>
                <Modal
                    title="新建结算方式"
                    visible={accountmethodStore.visible}
                    onOk={this.handleSubmit}
                    onCancel={accountmethodStore.hideModal}
                    okText="确认"
                    cancelText="取消"
...
export default Form.create()(AddAccountMethodComp);
