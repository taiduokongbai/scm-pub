...
@observer
class EditZhifuComp extends Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                let pm=Object.assign({},values,{langCode:"",subCode:"C012",id:zhifuStore.detail.id})
                zhifuStore.updateData(pm)
            }
        });
    }
    render() {
        ...
        return (
            <div>
                <Modal
                    title="编辑支付条款"
                    visible={zhifuStore.editVisible}
                    onOk={this.handleSubmit}
                    onCancel={zhifuStore.hideEditModal}
                    okText="确认"
                    cancelText="取消"
                            ...
                            >
                                {
                                    getFieldDecorator('catCode', {
                                        initialValue: zhifuStore.detail.catCode,
                                        rules: [
                            ...
                            >
                                {
                                    getFieldDecorator('catName', {
                                        initialValue: zhifuStore.detail.catName,
                                        rules: [
                            ...
                            >
                                {
                                    getFieldDecorator('catDesc', {
                                        initialValue: zhifuStore.detail.catDesc,
                                        rules: [
...
export default Form.create()(EditZhifuComp);
