...
@observer
class AddValuationComp extends Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                valuationStore.saveModalData(pm)
            }
        });
    }
    render() {
        ...
        return (
            <div>
                <Modal
                    title="新建计价元素"
                    visible={valuationStore.visible}
                    onOk={this.handleSubmit}
                    onCancel={valuationStore.hideModal}
                    okText="确认"
                    cancelText="取消"
...
export default Form.create()(AddValuationComp);
