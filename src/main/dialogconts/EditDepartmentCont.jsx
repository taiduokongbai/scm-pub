...
class AddDepartmentCont extends Component{
    constructor(props, context) {
        super(props, context);
        this.param={mgrPm:{"empCode":"","pageSize":"10"},deptNamePm:{"conditions":[]},addPm:{"isReg": "0","isMag": "1","isRep": "1","isSog": "1","isBil": "1","isOfe": "0","isVisible": "1"}}
            ...
            geteditdata(departmentId).then(json=>{
                if(json.status === 2000){
                    this.param={
                        ...
                        mgrPm:{
                            ...this.param.mgrPm,
                            empCode:this.props.Record.deptMgr
                        },
                    }
...
const mapStateToProps = (state) => ({
    ...
    codeRule: state.DepartmentRedu.get('codeRule'),
})
const mapDispatchToProps = (dispatch, ownProps) => ({
    ...
    getdeptMgr:(pm)=>{return dispatch(DepartmentAct.deptMgr(pm))},
})
