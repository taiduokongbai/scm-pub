...
class DeActivedMember extends Component {
    constructor(props, context) {
        ...
        columns[columns.length - 1].render = (txt, record, index) => (
            <div>
                ...
                >
                    <span href="#"  onClick={()=>this.onRecover(index,record)} title='恢复'><i className='c2mfont c2m-huifu columns-distribute'></i></span>
                </Popconfirm>
            </div>
        )
    ...
    handlerSubmitCallBack = (e) => {
        store.dispatch(DeactivedMemberAct.getDeactivedList({ employeeName: '', phone: '',page: 1, pageSize: 15}));
    }
