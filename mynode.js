...
app.all("*", function(req, resp, next) {
    ...
    if(/^1$/.test(query.corNode)){
        ...
        headerOpt.tokenId = "7962deb392d193a87b94373debe39680";
        headerOpt.cookie = "JSESSIONID=29ecee84-a289-4f5e-9674-8b2f94df04bd";
        reqOpt = Object.assign(reqOpt,{
            headers: headerOpt,
            method: req.method,
        ...
        request(reqOpt, function (error, response, body) {
            if (!error && response.statusCode == 200) {
                ...
                resp.send({"msg": "10.99.2.72 报错或者找不到资源","response":response});
            }
        });
    }else{
        next();
